...
nameProduct.addEventListener("input", function (event) {
  ...
  } else if (event.target.value.length < 4 || event.target.value.length > 100) {
    nameProductSpan.innerHTML = "Este campo debe tener entre 4 y 100 caracteres";
    nameProductSpan.style.color = "red";
    nameProduct.style.border = "1px solid red";
  } else if (
