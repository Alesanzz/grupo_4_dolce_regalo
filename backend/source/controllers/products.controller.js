...
const validNameCategorySeason = require("../utils/name-category-season");
...
const productController = {
    ...
    edit: function(req, res) {
        ...
        const success = (product) => {
            console.log(product.Category.dataValues.name);
    ...
    update: async function(req, res) {
        ...
        if (!result.isEmpty()) {
            // El mapped hace mas legible los errores para Java
            let errores = result.mapped();
            console.log('body', validNameCategorySeason(req.body));

            return res.render("products-views/product-edit", {
                errores: errores,
                data: validNameCategorySeason(req.body),
            });
        }
        // Si pasamos las validaciones, ocurre lo siguiente:
        try {
            ...
            if (category) {
                category.sku = req.body.category_sku;
            } else {
            ...
            if (season) {
                season.sku = req.body.season_sku;
            } else {
