            ...
            <div className="container-product">
                <div className="button-crear-producto m-4">
                    <button className="btn btn-success">
                        Crear Producto <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
                                        ...
                                        <div key={value.sku} className="card p-2 card-products" onClick={()=>viewProduct(value.sku)}>
                                            ...
                                            <div className="info-product">
                                                ...
                                                <button className="btn btn-primary form-control">
                                                    Añadir al carrito <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart-plus-fill" viewBox="0 0 16 16">
