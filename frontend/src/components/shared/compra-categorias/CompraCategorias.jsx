            ...
            <div className="container-compracategoria">
                <div className="row">
                    <div className="col-md-4 mt-2">
                        <div className="card">
                            <img src={rosas} alt="" />
                            <article className="infoBoxeCat">
                                <h3 className="tituloCat">Arreglos florales</h3>
                                <p>
                                    Variedad de tamaños, presentaciones, cantidad y flores -todos se pueden personalizar-
                                </p>
                                <a href="/">
                                    <button type="button" className="boton">Ver categoría</button></a>
                            </article>
                        </div>
                    </div>
                    <div className="col-md-4 mt-2">
                        <div className="card">
                            <img src={globos} alt="" />
                            <article className="infoBoxeCat">
                                <h3 className="tituloCat">Globos y dulces</h3>
                                <p>
                    ...
                    <div className="col-md-4 mt-2">
                        <div className="card">
                            ...
                            <article className="infoBoxeCat">
                                <h3 className="tituloCat">Desayunos</h3>
                                <p>
